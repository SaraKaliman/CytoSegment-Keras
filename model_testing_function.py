...
try:
    plot_results = eval(args.plot_results)
except AttributeError:
    print("Error: 'plot_results' argument is missing.")
except (TypeError, ValueError):
    print("Error: 'plot_results' must be a boolian (TRUE/FALSE).")

try:
    model_folder = str(args.model_folder)
except AttributeError:
    print("Error: 'model_folder' argument is missing.")
except (TypeError, ValueError):
    print("Error: 'model_folder' must be a valid string.")

try:
    test_set_folder = str(args.test_set_folder)
except AttributeError:
    print("Error: 'test_set_folder' argument is missing.")
except (TypeError, ValueError):
    print("Error: 'test_set_folder' must be a valid string.")
# -----------------------------------------------------------------------------


def model_testing_function(model_folder, test_set_folder, plot_results):
